...
#define SAT_WORKGROUP_SIZE_X 16
#define SAT_WORKGROUP_SIZE_Y 16

#define SAT_INPUT_IMAGE_BINDING 0
#define SAT_OUTPUT_IMAGE_BINDING 1

#define DOF_INPUT_SAT_TEXTURE_BINDING 0
